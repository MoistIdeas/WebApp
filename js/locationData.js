...
wellLoved = function() {
    ...
    return {
        ...
        updateDisplay: function(){
        	...
        	$("<h4 id=\"soilMoisture\" style=\"text-align: center\">Soil Moisture: " + Math.round(window.wellLoved.nearestPointData.soilMoisture*1000) + "L/m<sup>3</sup></h4>").insertAfter($("#samplingDistance"));
